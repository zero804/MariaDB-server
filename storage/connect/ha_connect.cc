...
extern "C" {
       char version[]= "Version " PLUGIN_CONNECT_VERSION " October 18, 2020";
#if defined(__WIN__)
       char compver[]= "Version " PLUGIN_CONNECT_VERSION " " __DATE__ " "  __TIME__;
       static char slash= '\\';
#else   // !__WIN__
       static char slash= '/';
#endif  // !__WIN__
...
maria_declare_plugin(connect)
{
  ...
  PLUGIN_CONNECT_VERSION,                       /* string version */
